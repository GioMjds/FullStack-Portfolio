...
const data = [
  {
    ...
    description: "I specialize in creating visually appealing user-friendly modern web applications that focuses on delivering seamless user experience through device responsiveness, accessibility standards and optimized performance.",
  },
  {
    id: 2,
        ...
        {data.map(({ id, icon, title, description }) => {
          return (
            <motion.div 
              ...
              className="services-card" key={id}>
              <i className={icon}></i>
